...
public class GUI_Config extends JFrame {
    ...
    public GUI_Config(File config) {
        ...
        //btnGet.setToolTipText(STATICS.DISCORD_GET_TOKEN);
        ...
        btnGet.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                   // Desktop.getDesktop().browse(new URI(STATICS.DISCORD_GET_TOKEN));
                } catch (Exception e1) {
        ...
        spinnerStartingVolume.setModel(new SpinnerNumberModel(100, 0, STATICS.MAX_VOUME, 5));
        ...
        btnApply.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                if(Config.save()) {
                    ...
                    JOptionPane.showMessageDialog(instance, "Failed to save config.", STATICS.BOT_NAME, JOptionPane.ERROR_MESSAGE);
                }
    ...
    private static String checkValue(String v) {
        if(v.contains(STATICS.CONFIG_COMMENT)) {
            JOptionPane.showMessageDialog(instance, "Invalid config value: " + v + "\n'#' is not allowed.", STATICS.BOT_NAME, JOptionPane.WARNING_MESSAGE);
            return "";
        }
        return v;
    }
