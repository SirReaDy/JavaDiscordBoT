...
public class Utils {
    ...
    public static String getOS() {
        ...
        if(tmp.equals(STATICS.OS_LINUX)) {
            return (OS = STATICS.OS_LINUX);
        } else if(tmp.startsWith(STATICS.OS_WINDOWS)) {
            return (OS = STATICS.OS_WINDOWS);
        } else {
            return (OS = STATICS.UNKNOWN_OS);
        }
    }

    public static boolean isUnknownOS() {
        return getOS().equals(STATICS.UNKNOWN_OS);
    }
