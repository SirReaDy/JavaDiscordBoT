...
public class Stats implements Command {
    ...
    @Override
    public Game action(String[] args, MessageReceivedEvent event) throws ParseException {
        ...
        EmbedBuilder eb = new EmbedBuilder()
                ...
                .addField("Server Creation Date", g.getCreationTime().format(DateTimeFormatter.ISO_DATE_TIME), false);
